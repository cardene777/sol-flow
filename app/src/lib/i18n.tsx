...
const translations: Record<Language, Translations> = {
  en: {
    landing: {
      ...
      feature6Description: 'Major libraries like OpenZeppelin and Solady are preloaded. Reference them immediately.',
  ...
  ja: {
    landing: {
      ...
      feature6Description: 'OpenZeppelin、Solady等の主要ライブラリがプリロード済み。すぐに参照できます。',
